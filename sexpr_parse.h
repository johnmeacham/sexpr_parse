...
// What to do on error
// 0 - ignore unknown characters and continue parsing
// 1 - print a warning and continue parsing
// 2 - print an error and return -1
// 3 - user implemented sp_error
#define SP_ERROR 1
...
/* this is called when an unknown character is encountered, if it returns a
 * negative number, the parser will stop and return that as the error code,
